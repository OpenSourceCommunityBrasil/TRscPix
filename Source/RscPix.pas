                           ...
                           case FPSP.TipoPsp of
                             pspSicredi:
                              begin
                                 ...
                                 case FPSP.TipoPspAmbiente of
                                   taSandBox:
                                    begin
                                      RequestBody.Add('{"calendario": {"expiracao": "300"},"valor": {"original":"32.45"},"chave":"testeconectividadeapi10@santander.com.br","solicitacaoPagador": "","infoAdicionais": []}');
                                    end;
                                  {......................................................................}
                                   taHomologacao:
                                    begin
                             ...
                             pspSantander:
                              begin
                                DWCR_CobCriar.Accept           := '*/*';
                                DWCR_CobCriar.AcceptEncoding   := 'gzip, deflate, br';
                                DWCR_CobCriar.ContentEncoding  := '';

                                RequestBody.Add('Authorization=Bearer '  + Token.AcessToken);
                                DWCR_CobCriar.AuthenticationOptions.AuthorizationOption  := rdwAONone;

                                 case FPSP.TipoPspAmbiente of
                                   taSandBox:
                                    begin
                                     cURL := FPSP.URLApi + FPSP.EndPoint_Cob;
                                     cURL := StringReplace(cURL, '{txid}', 'cd1fe328-c875-4812-85a6-f233ae41b662' , [rfReplaceAll]);
                                      RequestBody.Add('{"calendario": {"expiracao": "300"},"valor": {"original":"32.45"},"chave":"testeconectividadeapi10@santander.com.br","solicitacaoPagador": "","infoAdicionais": []}');
                                    end;
                                  {......................................................................}
                                   taHomologacao:
